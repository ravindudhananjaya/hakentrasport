...
class StatsOverview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final onBoard = employees
        .where(
          (e) =>
              e.weeklyPickupStatus.contains(TransportStatus.ON_BOARD) ||
              e.weeklyDropoffStatus.contains(TransportStatus.ON_BOARD),
        )
        .length; // Very loose logic
